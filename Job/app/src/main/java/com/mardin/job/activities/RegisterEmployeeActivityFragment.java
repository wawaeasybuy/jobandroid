 ...
 */
public class RegisterEmployeeActivityFragment extends Fragment {
    ...
    public RegisterEmployeeActivityFragment() {
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        getActivity().setTitle(R.string.title_regemployee);
    ...
    public void registerAction() {
        ...
        globalProvider.post(getActivity(), Constants.regCanStr, params, new RequestListener() {
            @Override
