...
public class PositionAdapter extends BaseAdapter{
    ...
    public boolean adJustToOpen(){
        if(GlobalProvider.getInstance().employer.getName()==null||GlobalProvider.getInstance().employer.getName().equals("")||GlobalProvider.getInstance().employer.getCompanyname()==null||GlobalProvider.getInstance().employer.getCompanyname().equals("")||GlobalProvider.getInstance().employer.getMainBusiness()==null||GlobalProvider.getInstance().employer.getMainBusiness().equals("")||GlobalProvider.getInstance().employer.getCompanyURL()==null||GlobalProvider.getInstance().employer.getCompanyURL().equals("")||GlobalProvider.getInstance().employer.getCompanyAddress()==null||GlobalProvider.getInstance().employer.getCompanyAddress().equals("")||GlobalProvider.getInstance().employer.getCompanyInfo()==null||GlobalProvider.getInstance().employer.getCompanyInfo().equals("")||GlobalProvider.getInstance().employer.getDetailedCompanyAddress()==null){
            return false;
        }else{
            return true;
        }
